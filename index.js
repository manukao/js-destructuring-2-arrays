...
export const [name, price, quantity] = ["Egg", 0.25, 12];
...
export const [ageOfChris, firstNameOfChris, lastNameOfChris] = [
  12,
  "Chris",
  "Owen",
];
...
export const [firstNameOfAlex, , lastNameOfAlex] = ["Alex", 12, "Main"];
// EXERCISE 4
// Use array destructuring to extract the last name from the array
// as variable called "lastName".

const students = ["Christina", "Jon", "Alexandare"];
export const [, , lastName] = ["Christina", "Jon", "Alexandare"];
// EXERCISE 5
